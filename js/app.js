(() => {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const feedbackOne = document.querySelector(".user-feedback-reviews_one");
        const feedbackTwo = document.querySelector(".user-feedback-reviews_two");
        const feedbackThre = document.querySelector(".user-feedback-reviews_three");
        const feedbackFour = document.querySelector(".user-feedback-reviews_four");
        const feedbackButtonOne = document.querySelector(".item-reviews__button_one");
        const feedbackButtonTwo = document.querySelector(".item-reviews__button_two");
        const feedbackButtonThree = document.querySelector(".item-reviews__button_three");
        const feedbackButtonFour = document.querySelector(".item-reviews__button_four");
        if (feedbackButtonOne) feedbackButtonOne.addEventListener("click", (function(e) {
            feedbackOne.classList.toggle("_active-user-feedback-reviews");
            feedbackButtonOne.classList.toggle("_active-item-reviews__button");
        }));
        if (feedbackButtonTwo) feedbackButtonTwo.addEventListener("click", (function(e) {
            feedbackTwo.classList.toggle("_active-user-feedback-reviews");
            feedbackButtonTwo.classList.toggle("_active-item-reviews__button");
        }));
        if (feedbackButtonThree) feedbackButtonThree.addEventListener("click", (function(e) {
            feedbackThre.classList.toggle("_active-user-feedback-reviews");
            feedbackButtonThree.classList.toggle("_active-item-reviews__button");
        }));
        if (feedbackButtonFour) feedbackButtonFour.addEventListener("click", (function(e) {
            feedbackFour.classList.toggle("_active-user-feedback-reviews");
            feedbackButtonFour.classList.toggle("_active-item-reviews__button");
        }));
    }));
    window["FLS"] = true;
    isWebp();
